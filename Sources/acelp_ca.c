...
static void Cor_h(Word16 *H, /* (i) Q12 :Impulse response of filters */
...
Word16 *rr /* (o)     :Correlations of H[]         */
	...
	Word16 * restrict p0, * restrict p1, * restrict p2, * restrict p3, * restrict p4;
...
Word16 dn[], /* (i)    : Correlations between h[] and Xn[].       */
Word16 rr[], /* (i)    : Correlations of impulse response h[].    */
Word16 h[restrict], /* (i) Q12: Impulse response of filters.             */
Word16 cod[], /* (o) Q13: Selected algebraic codeword.             */
Word16 y[restrict], /* (o) Q12: Filtered algebraic codeword.             */
Word16 *sign /* (o)    : Signs of 4 pulses.                       */
) {
	...
	for (i0 = 0; i0 < L_SUBFR; i0 += STEP)
	{
		...
		{
			/* fix pointer increment by Slavka */
