...
void Lsp_lsf(Word16 lsp[restrict], /* (i) Q15 : lsp[m] (range: -1<=val<1)                */
Word16 lsf[restrict] /* (o) Q15 : lsf[m] normalized (range: 0.0<=val<=0.5) */
) {
	Word16 i, ind, tmp;
	Word32 L_tmp;
...
void Lsf_lsp2(Word16 lsf[restrict], /* (i) Q13 : lsf[m] (range: 0.0<=val<PI) */
Word16 lsp[restrict] /* (o) Q15 : lsp[m] (range: -1<=val<1)   */
) {
	Word16 i, ind;
	Word16 offset; /* in Q8 */
...
void Lsp_lsf2(Word16 lsp[restrict], /* (i) Q15 : lsp[m] (range: -1<=val<1)   */
Word16 lsf[restrict] /* (o) Q13 : lsf[m] (range: 0.0<=val<PI) */
) {
	Word16 i, ind;
...
void Weight_Az(Word16 a[restrict], /* (i) Q12 : a[m+1]  LPC coefficients             */
Word16 gamma, /* (i) Q15 : Spectral expansion factor.           */
Word16 ap[restrict] /* (o) Q12 : Spectral expanded LPC coefficients   */
) {
	Word16 i, fac;
