...
static void Gbk_presel(Word16 best_gain[], /* (i) [0] Q9 : unquantized pitch gain     */
...
Word16 past_qua_en[4]) {
	...
	Gain_predict(past_qua_en, code, &gcode0, &exp_gcode0);
