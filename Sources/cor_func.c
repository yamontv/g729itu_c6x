 ...
 *--------------------------------------------------------------------------*/
void Cor_h_X(Word16 h[restrict], /* (i) Q12 :Impulse response of filters      */
Word16 X[restrict], /* (i)     :Target vector                    */
Word16 D[restrict] /* (o)     :Correlations between h[] and D[] */
